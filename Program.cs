        ...
        while (true)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    {
                        case "1":
                            var allGradesReportStrategy = new AllGradesReportStrategy();
                            controller.GenerateReport(allGradesReportStrategy);
                            Console.WriteLine();
                            break;
                        case "2":
                            var averageGradeReportStrategy = new AverageGradeReportStrategy();
                            controller.GenerateReport(averageGradeReportStrategy);
                            Console.WriteLine();
                            break;
                        default:
